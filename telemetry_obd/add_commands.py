...
def fuel_rate_2(messages):
    ...
    sensor_a = (((256.0 * d[0]) + d[1]) / 50.0) * 3.78541 * ureg.liter / ureg.second if d[0] & 1 else None
...
NEW_COMMANDS = [
    ...
    OBDCommand("TRANSMISSION_ACTUAL_GEAR", "Transmission actual gear", b"01A4", 4, raw_string, ECU.ENGINE, True),
